...
{
     [LoginActionFilter]
    public class PsdbrkController:BaseController
    {
        /// <summary>
        /// 查询
        /// </summary>
        ...
        public ActionResult List()
        {
            ...
            try
            {
                ...
                var userShops = GetCurrentUserMgrShop(id_user,id_shop);//GetShop(Enums.ShopDataType.UserShopOnly); //GetUserShop();
                if (!param.Contains("s_id_shop"))//user_id_shops
                {
                    if (userShops.Any())
                    {
                ...
                pn = BusinessFactory.Td_Ps_Dbrk_1.GetPage(param);
                var plist = new PageList<Td_Ps_Dbrk_1_Query>(pn, pageIndex, limit);
        ...
        public ActionResult Add(string id)
        {
            ViewData["option"] = "add";
            //用户管理门店
            ViewData["userShopList"] = GetCurrentUserMgrShop(id_user, id_shop);// GetShop(Enums.ShopDataType.UserShop, id_user);
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                param.Add("id", id);
                param.Add("id_masteruser", id_user_master);
                ViewData["item_edit"] = BusinessFactory.Td_Ps_Dbrk_1.Get(param).Data;
        ...
        [HttpPost]
        [ActionPurview(true)]
        public ActionResult Add(DbrkModel model)
        {
            var res = HandleResult(() =>
            {
                ...
                var br = BusinessFactory.Td_Ps_Dbrk_1.Add(model);
                return br;
            });
        ...
        public ActionResult Edit(string id)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                param.Add("id", id);
                param.Add("id_masteruser", id_user_master);
                var model = BusinessFactory.Td_Ps_Dbrk_1.Get(param).Data as DbrkQueryModel;
                if (model != null)
                {
                    ViewData["dh"] = model.dbrk1.dh;
        ...
        [HttpPost]
        [ActionPurview(true)]
        public ActionResult Edit(DbrkModel model)
        {
            var res = HandleResult(() =>
            {
                model.id_masteruser = id_user_master;
                model.id_create = id_user;
                //model.id_shop = id_shop;
                return BusinessFactory.Td_Ps_Dbrk_1.Update(model);
            });
            return JsonString(res, 1);
        }
        #endregion
        ...
        public ActionResult Sh(string id)
        {
            var res = HandleResult(() =>
            {
                ...
                return BusinessFactory.Td_Ps_Dbrk_1.Active(param);
            });
            return JsonString(res, 1);
        }
        ...
        public ActionResult Delete(string id)
        {
            var res = HandleResult(() =>
            {
                ...
                param.Add("id_masteruser", id_user_master);
                param.Add("id_user", id_user);
                return BusinessFactory.Td_Ps_Dbrk_1.Delete(param);
            });
            return JsonString(res, 1);
        }
        /// <summary>
        ...
        public ActionResult ZF(string id)
        {
            var res = HandleResult(() =>
            {
                ...
                param.Add("id_masteruser", id_user_master);
                param.Add("id_user", id_user);
                return BusinessFactory.Td_Ps_Dbrk_1.Stop(param);
            });
            return JsonString(res, 1);
        }
        [HttpGet]
        [ActionPurview(true)]
        [ActionAlias("psdbrk","list")]
