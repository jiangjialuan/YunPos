...
{
    [LoginActionFilter]
    public class XsController : BaseController
    {
        ...
        public ActionResult List()
        {
            ...
            try
            {
                ...
                pn = BusinessFactory.Td_Xs_Dd_1.GetPage(param);
                var plist = new PageList<Td_Xs_Dd_1_QueryModel>(pn, pageIndex, limit);
        ...
        public ActionResult Add()
        {
            ...
            {
                var br = BusinessFactory.Td_Xs_Dd_1.Get(param);
                if (br.Success)
                {
        ...
        public ActionResult Delete()
        {
            ...
            try
            {
                ...
                br = BusinessFactory.Td_Xs_Dd_1.Delete(param);
            }
            catch (Exception ex)
            {
                br.Message.Add(ex.Message);
            }
            WriteDBLog("销售订单-删除", oldParam, br);
        ...
        public ActionResult GetDhDetailList()
        {
            ...
            try
            {
                ...
                if (param.ContainsKey("id") && !string.IsNullOrEmpty(param["id"].ToString()))
                {
                    br = BusinessFactory.Td_Xs_Dd_1.Get(param);
                }
        ...
        public ActionResult CreateDH()
        {
            ...
            {
                br.Success = true;
                br.Data = GetNewDH(Enums.FlagDJLX.XSDD);
                return JsonString(br);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Stop()
        {
            ...
            try
            {
                param_model = param.Trim(pv);
                oldParam = (Hashtable)param_model.Clone();
                br = BusinessFactory.Td_Xs_Dd_1.Stop(param);
            }
            catch (Exception ex)
            {
                br.Message.Add(ex.Message);
            }
            WriteDBLog("销售订单-作废", oldParam, br);
            return JsonString(br, 1);
        }
        #endregion
        ...
        public ActionResult Search()
        {
            ...
            try
            {
                ...
                pv.Add("xs_callback", "", HandleType.Remove);
                ...
                {
                    ViewData["s_id_shop"] = param["id_shop"];
                }
                ...
                if (param.ContainsKey("xs_callback") && !string.IsNullOrEmpty(param["xs_callback"].ToString()))
                    ViewData["xs_callback"] = param["xs_callback"].ToString();
        ...
        public FileResult DownloadExcelTemp()
        {
            try
            {
                ...
                ISheet sheet1 = NPOIHelper.CreateSheet(book, e_param, e_param_comment, "销售订单商品资料模板");
                ...
                rowtemp.CreateCell(4).SetCellValue("2016-09-24销售订单商品");
                ...
                return File(ms, "application/vnd.ms-excel", "销售订单商品资料模板-" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".xls");
        ...
        private string SaveFailFile(List<Tb_JhShopsp_Import> failList)
        {
            try
            {
                string fileName = "销售订单商品导入失败数据" + DateTime.Now.ToString("yyyyMMddHHmmssfff") + ".xls";
                ...
                ISheet sheet1 = NPOIHelper.CreateSheet(book, e_param, e_param_comment, "销售订单商品资料模版");
                int i = 1;
        ...
        public FileResult ImportOut()
        {
            ...
            ISheet sheet1 = NPOIHelper.CreateSheet(book, e_param, e_param_comment, "销售订单商品资料导出");
            System.IO.MemoryStream ms = new System.IO.MemoryStream();
            #endregion
            ...
            try
            {
                ...
                if (shopspList == null || shopspList.Count() <= 0)
                {
                    ...
                    book.Write(ms);
                    ms.Seek(0, SeekOrigin.Begin);
                    return File(ms, "application/vnd.ms-excel", "销售订单商品资料导出-" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".xls");
                }
                #endregion
                #region 数量、单价、金额小数点
                var digit = GetParm();
        ...
        public ActionResult AllowCK()
        {
            ...
            {
                param_model = param.Trim(pv);
                br = BusinessFactory.Td_Xs_Dd_1.Export(param);
            }
            catch (Exception ex)
            {
                br.Message.Add(ex.Message);
