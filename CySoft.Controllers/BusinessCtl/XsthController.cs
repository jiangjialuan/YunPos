...
{
    [LoginActionFilter]
    public class XsthController : BaseController
    {
        #region 销售退货-查询
        /// <summary>
        /// 销售退货-查询
        ...
        public ActionResult List()
        {
            ...
            try
            {
                ...
                pn = BusinessFactory.Td_Xs_Th_1.GetPage(param);
                var plist = new PageList<Td_Xs_Th_1_QueryModel>(pn, pageIndex, limit);
        ...
        public ActionResult Add()
        {
            ...
            p.Add("id_jh", string.Empty, HandleType.Remove);//id_jh
            ...
            {
                var br = BusinessFactory.Td_Xs_Th_1.Get(param);
                if (br.Success)
                {
                    ViewBag.CopyInfo = br.Data;
                }
            }
            else if (param.ContainsKey("id_jh") && !string.IsNullOrEmpty(param["id_jh"].ToString()))
            {
                Hashtable ht = new Hashtable();
                ht.Add("id", param["id_jh"].ToString());
                var br = BusinessFactory.Td_Xs_1.Get(ht);
                if (br.Success)
                {
                    ViewBag.CopyXsckInfo = br.Data;
                }
            }
        ...
        public ActionResult Add(Tb_Shopsp model)
        {
            ...
            try
            {
                ...
                p.Add("je_st", string.Empty, HandleType.ReturnMsg);//je_st
                ...
                List<Td_Xs_Th_2> shopspList = JSON.Deserialize<List<Td_Xs_Th_2>>(param["shopspList"].ToString()) ?? new List<Td_Xs_Th_2>();
                ...
                if (shopspList == null || shopspList.Count() <= 0)
                {
                    ...
                    br.Data = "shopspList";
                    WriteDBLog("销售退货-Post新增/编辑", oldParam, br);
                ...
                {
                    br = BusinessFactory.Td_Xs_Th_1.Update(param);
                    WriteDBLog("销售退货-Post编辑", oldParam, br);
                }
                else
                {
                    //插入表
                    br = BusinessFactory.Td_Xs_Th_1.Add(param);
                    WriteDBLog("销售退货-Post新增", oldParam, br);
                }
        ...
        public ActionResult Delete()
        {
            ...
            try
            {
                ...
                br = BusinessFactory.Td_Xs_Th_1.Delete(param);
            }
            catch (Exception ex)
            {
                br.Message.Add(ex.Message);
            }
            WriteDBLog("销售退货-删除", oldParam, br);
        ...
        public ActionResult Stop()
        {
            ...
            try
            {
                param_model = param.Trim(pv);
                oldParam = (Hashtable)param_model.Clone();
                br = BusinessFactory.Td_Xs_Th_1.Stop(param);
            }
            catch (Exception ex)
            {
                br.Message.Add(ex.Message);
        ...
        public ActionResult CreateDH()
        {
            ...
            {
                br.Success = true;
                br.Data = GetNewDH(Enums.FlagDJLX.XSTH);
        ...
        public ActionResult Sh()
        {
            ...
            try
            {
                ...
                param.Add("id_user", id_user);
                oldParam = (Hashtable)param.Clone();
                br = BusinessFactory.Td_Xs_Th_1.Active(param);
            }
            catch (Exception ex)
            {
                br.Message.Add(ex.Message);
            }
            WriteDBLog("销售退货-审核", oldParam, br);
            return JsonString(br, 1);
        }
        #endregion
        ...
        public FileResult ImportOut()
        {
            ...
            ISheet sheet1 = NPOIHelper.CreateSheet(book, e_param, e_param_comment, "销售退货商品资料导出");
            ...
            try
            {
                ...
                if (shopspList == null || shopspList.Count() <= 0)
                {
                    ...
                    return File(ms, "application/vnd.ms-excel", "销售退货商品资料导出-" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".xls");
                }
                #endregion
                #region 数量、单价、金额小数点
                var digit = GetParm();
            ...
            catch (Exception ex)
            {
                ...
                rowtempe.CreateCell(6).SetCellValue("销售退货导出出现异常 请重试");
                sheet1.GetRow(1).Height = 28 * 20;
                // 写入到客户端 
                book.Write(ms);
                ms.Seek(0, SeekOrigin.Begin);
        ...
        private string SaveFailFile(List<Tb_JhShopsp_Import> failList)
        {
            try
            {
                string fileName = "销售退货商品导入失败数据" + DateTime.Now.ToString("yyyyMMddHHmmssfff") + ".xls";
                ...
                ISheet sheet1 = NPOIHelper.CreateSheet(book, e_param, e_param_comment, "销售退货商品资料模版");
                int i = 1;
        ...
        public FileResult DownloadExcelTemp()
        {
            try
            {
                ...
                book.Write(ms);
                ms.Seek(0, SeekOrigin.Begin);
                return File(ms, "application/vnd.ms-excel", "销售退货商品资料模板-" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".xls");
