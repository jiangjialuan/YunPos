...
{
     [LoginActionFilter]
    public class PsfptzdController:BaseController
    {
        /// <summary>
        /// 查询
        /// </summary>
        ...
        public ActionResult List()
        {
            ...
            try
            {
                ...
                if (userShopList.Any())
                {
                    var id_shops = (from a in userShopList select a.id_shop).ToArray();
                    param.Add("user_id_shops", id_shops);
                }
                #endregion
                PageNavigate pn = new PageNavigate();
                pn = BusinessFactory.Td_Ps_Fptzd_1.GetPage(param);
                var plist = new PageList<Td_Ps_Fptzd_1_Query>(pn, pageIndex, limit);
                plist.PageIndex = pageIndex;
                plist.PageSize = limit;
                ViewData["List"] = plist;
                ViewData["sort"] = param["sort"]; //排序规则需要返回前台  
                ViewBag.DigitHashtable = GetParm();
                ViewData["userShopList"] = userShopList; //GetShop(Enums.ShopDataType.UserShop); //GetUserShop();
            }
            catch (Exception ex)
            {
                return HttpNotFound();
        ...
        public ActionResult Add(string id)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                param.Add("id", id);
                param.Add("id_masteruser", id_user_master);
                ViewData["item_edit"] = BusinessFactory.Td_Ps_Fptzd_1.Get(param).Data;
        ...
        [HttpPost]
        [ActionPurview(true)]
        public ActionResult Add(FptzdModel model)
        {
            var res = HandleResult(() =>
            {
                ...
                var br = BusinessFactory.Td_Ps_Fptzd_1.Add(model);
                return br;
            });
        ...
        public ActionResult Edit(string id)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                param.Add("id", id);
                param.Add("id_masteruser", id_user_master);
                var model = BusinessFactory.Td_Ps_Fptzd_1.Get(param).Data as FptzdQueryModel;
                if (model != null)
                {
                    ViewData["dh"] = model.Fptzd1.dh;
        ...
        [HttpPost]
        [ActionPurview(true)]
        public ActionResult Edit(FptzdModel model)
        {
            var res = HandleResult(() =>
            {
                model.id_masteruser = id_user_master;
                model.id_create = id_user;
                model.id_shop = id_shop;
                return BusinessFactory.Td_Ps_Fptzd_1.Update(model);
            });
            return JsonString(res, 1);
        }
        #endregion
        ...
        public ActionResult Sh(string id)
        {
            var res = HandleResult(() =>
            {
                ...
                return BusinessFactory.Td_Ps_Fptzd_1.Active(param);
            });
            return JsonString(res, 1);
        }
        ...
        public ActionResult ZF(string id)
        {
            var res = HandleResult(() =>
            {
                ...
                param.Add("id_masteruser", id_user_master);
                param.Add("id_user", id_user);
                return BusinessFactory.Td_Ps_Fptzd_1.Stop(param);
            });
            return JsonString(res, 1);
        }
         [HttpPost]
        ...
        public ActionResult Delete(string id)
        {
            var res = HandleResult(() =>
            {
                ...
                param.Add("id_masteruser", id_user_master);
                param.Add("id_user", id_user);
                return BusinessFactory.Td_Ps_Fptzd_1.Delete(param);
            });
            return JsonString(res, 1);
        }
        /// <summary>
        ...
        public ActionResult SearchList()
        {
            ...
            try
            {
                ...
                pv.Add("pageSize", limit, HandleType.DefaultValue);
                pv.Add("keyword", "", HandleType.Remove, true);
                pv.Add("id_shop_ck", String.Empty, HandleType.Remove);
                ...
                if (param.ContainsKey("s_id_shop_ck"))
                {
                    ...
                    param["id_shop_ck"] = param["s_id_shop_ck"];
        ...
        /// <returns></returns>
        [ActionPurview(false)]
        public ActionResult QueryFptzdSpmx(string id)
        {
            var res = HandleResult(() =>
            {
                Hashtable param = new Hashtable();
                ...
                param.Add("id_masteruser", id_user_master);
                param.Add("forps","");
                return BusinessFactory.Td_Ps_Fptzd_1.Get(param);
            });
