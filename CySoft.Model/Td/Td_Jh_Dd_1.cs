...
{
    [Serializable]
    [Table("td_jh_dd_1", "Td_Jh_Dd_1")]
    [DebuggerDisplay("id = {id}")]
    public class Td_Jh_Dd_1
    {
        #region public method

        public Td_Jh_Dd_1 Clone()
        {
            return (Td_Jh_Dd_1)this.MemberwiseClone();
        }
        ...
        public Nullable<byte> flag_jyfs
        {
            get
            {
                return _flag_jyfs;
    ...
    public class Td_Jh_Dd_1_QueryModel : Td_Jh_Dd_1
    {
        #region public method

        public Td_Jh_Dd_1_ApiModel CloneApiModel()
        {
            var model= (Td_Jh_Dd_1_QueryModel)this.MemberwiseClone();
            Td_Jh_Dd_1_ApiModel rModel = new Td_Jh_Dd_1_ApiModel();
            rModel.id = model.id;
            rModel.rq = model.rq;
            rModel.dh = model.dh;
            rModel.id_gys = model.id_gys;
    ...
    public class Td_Jh_Dd_1_Query_DetailModel
    {
        public Td_Jh_Dd_1_QueryModel head { set; get; }
        public List<Td_Jh_Dd_2_QueryModel> body { set; get; }
    }



    public class Td_Jh_Dd_1_ApiModel
    {
    ...
    public class Td_Jh_Dd_2_ApiModel
    {
