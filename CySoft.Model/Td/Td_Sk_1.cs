...
{
    [Serializable]
    [Table("td_sk_1", "Td_Sk_1")]
    [DebuggerDisplay("id = {id}")]
    public class Td_Sk_1
    {
        #region public method

        public Td_Sk_1 Clone()
        {
            return (Td_Sk_1)this.MemberwiseClone();
        }
        ...
        /// 1、应收2、预收
        /// </summary>
        public Nullable<byte> flag_sklx
        {
            get
            {
                return _flag_sklx;
        ...
        /// =sum(je_sk)
        /// </summary>
        public Nullable<decimal> je_sk_mxtotal
        {
            get
            {
                return _je_sk_mxtotal;
            }
            set
            {
                if (value.HasValue)
                {
                    _je_sk_mxtotal = value.Value;
                }
                else
                {
                    _je_sk_mxtotal = 0m;
    ...
    public class Td_Sk_1_QueryModel : Td_Sk_1
    {
    ...
    public class Td_Sk_1_Query_DetailModel
    {
        public Td_Sk_1_QueryModel head { set; get; }
        public List<Td_Sk_2_QueryModel> body { set; get; }
