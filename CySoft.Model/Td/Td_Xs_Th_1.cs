...
{
    [Serializable]
    [Table("td_xs_th_1", "Td_Xs_Th_1")]
    [DebuggerDisplay("id = {id}")]
    public class Td_Xs_Th_1
    {
        #region public method

        public Td_Xs_Th_1 Clone()
        {
            return (Td_Xs_Th_1)this.MemberwiseClone();
        }
    ...
    public class Td_Xs_Th_1_QueryModel : Td_Xs_Th_1
    {
        ...
        public decimal? je_ys { set; get; }
        public string create_name { set; get; }
        public string sh_name { set; get; }
    }


    public class Td_Xs_Th_1_Query_DetailModel
    {
        public Td_Xs_Th_1_QueryModel head { set; get; }
        public List<Td_Xs_Th_2_QueryModel> body { set; get; }
