...
{
    [Serializable]
    [Table("td_jh_dd_2", "Td_Jh_Dd_2")]
    [DebuggerDisplay("id = {id}")]
    public class Td_Jh_Dd_2
    {
        #region public method

        public Td_Jh_Dd_2 Clone()
        {
            return (Td_Jh_Dd_2)this.MemberwiseClone();
        }
    ...
    public class Td_Jh_Dd_2_QueryModel : Td_Jh_Dd_2
    {

        #region public method

        public Td_Jh_Dd_2_ApiModel CloneApiModel()
        {
            var model = (Td_Jh_Dd_2_QueryModel)this.MemberwiseClone();
            Td_Jh_Dd_2_ApiModel rModel = new Td_Jh_Dd_2_ApiModel();
