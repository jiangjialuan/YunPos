...
{
    [Serializable]
    [Table("td_xs_th_2", "Td_Xs_Th_2")]
    [DebuggerDisplay("id = {id}")]
    public class Td_Xs_Th_2
    {
        #region public method

        public Td_Xs_Th_2 Clone()
        {
            return (Td_Xs_Th_2)this.MemberwiseClone();
        }
    ...
    public class Td_Xs_Th_2_QueryModel : Td_Xs_Th_2
    {
