    ...
    public class DZHGModel:BaseCx
    {
        ...
        public override void CheckParam()
        {
                ...
                && sl_largess_1 == 0)
            {
                ...
                {
                    Errors.Add("规则二的条件数值不能小于规则一的条件数值!");
                    return ;
                }
                if (condition_3 > 0 && condition_3 < condition_2)
                {
                    Errors.Add("规则三的条件数值不能小于规则二的条件数值!");
                    return ;
                }
            }
