...
namespace CySoft.Utility
{
    ...
    ///  ConnectionMultiplexer redis = ConnectionMultiplexer.Connect("192.168.1.111:6379,192.168.1.112:6379");
    ...
    /// 不过提供连接池等阻塞和等待的手段是和作者的设计理念相违背的。
    /// StackExchange.Redis这里使用管道和多路复用的技术来实现减少连接
    /// 
    ...
    {
        //private static readonly string Coonstr = "192.168.1.111:6379";
        private static readonly string Coonstr = AppConfig.GetValue("RedisHost");
        private static object _locker = new object();
        private static ConnectionMultiplexer _instance = null;
        private static string SystemModuleName = "YUNPOS_{0}";
        ...
        {
            return string.Format(SystemModuleName, key);
        }
        /// <summary>
        /// 根据key获取缓存对象
        /// </summary>
            ...
            where T : class, new()
        {
            ...
            string value = GetDatabase().StringGet(key).ToString();
        ...
        {
            key = MergeKey(key);
            //return GetDatabase().StringSet(key: key, value: Serialize(value));
            return GetDatabase().StringSet(key: key, value: JSON.Serialize(value));
        }

        public static bool Set(string key, dynamic value, TimeSpan? expiry = default(TimeSpan?), When when = When.Always, CommandFlags flags = CommandFlags.None)
        {
            key = MergeKey(key);
            //return GetDatabase().StringSet(key: key, value: Serialize(value), expiry: expiry);
            return GetDatabase().StringSet(key: key, value: JSON.Serialize(value), expiry: expiry);
        }
        ...
        private static void MuxerErrorMessage(object sender, RedisErrorEventArgs e)
        {
            ...
            //LogHelper.Info("ErrorMessage: " + e.Message);
            TextLogHelper.WriterExceptionLog("ErrorMessage: " + e.Message);
        }
        /// <summary>
        /// 重新建立连接之前的错误
        /// </summary>
        ...
        private static void MuxerConnectionRestored(object sender, ConnectionFailedEventArgs e)
        {
            ...
            //LogHelper.Info("ConnectionRestored: " + e.EndPoint);
            TextLogHelper.WriterExceptionLog("Connection Restored: " + e.EndPoint);
        }
        /// <summary>
        ...
        private static void MuxerConnectionFailed(object sender, ConnectionFailedEventArgs e)
        {
            ...
            //LogHelper.Info("重新连接：Endpoint failed: " + e.EndPoint + ", " + e.FailureType + (e.Exception == null ? "" : (", " + e.Exception.Message)));
            TextLogHelper.WriterExceptionLog("重新连接：Endpoint failed: " + e.EndPoint + ", " + e.FailureType + (e.Exception == null ? "" : (", " + e.Exception.Message)));
        }
        /// <summary>
        /// 更改集群
        /// </summary>
        ...
        private static void MuxerHashSlotMoved(object sender, HashSlotMovedEventArgs e)
        {
            ...
            //LogHelper.Info("HashSlotMoved:NewEndPoint" + e.NewEndPoint + ", OldEndPoint" + e.OldEndPoint);
            TextLogHelper.WriterExceptionLog("HashSlotMoved:NewEndPoint" + e.NewEndPoint + ", OldEndPoint" + e.OldEndPoint);
        }
        /// <summary>
        /// redis类库错误
        /// </summary>
        ...
        private static void MuxerInternalError(object sender, InternalErrorEventArgs e)
        {
            ...
            //LogHelper.Info("InternalError:Message" + e.Exception.Message);
            TextLogHelper.WriterExceptionLog("InternalError:Message" + e.Exception.Message);
        }
