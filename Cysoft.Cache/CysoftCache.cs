...
namespace Cysoft.Cache
{
    /// <summary>
    /// Cysoft缓存类
    /// 对缓存进行全局控制管理
    /// </summary>
    public class CysoftCache
    {
        private static XmlElement objectXmlMap;
        private static ICacheStrategy cs;
        private static volatile CysoftCache instance = null;
        ...
        /// </summary>
        /// <returns></returns>
        public static CysoftCache GetCacheService()
        {
            if (instance == null)
            {
                lock (lockHelper)
