...
{
    public class Td_Ps_Fptzd_1BLL : BaseBLL
    {
        ...
        public override PageNavigate GetPage(Hashtable param = null)
        {
            ...
            var totalCount = DAL.GetCount(typeof(Td_Ps_Fptzd_1), param);
            if (totalCount > 0)
            {
                pn.Data = DAL.QueryPage<Td_Ps_Fptzd_1_Query>(typeof(Td_Ps_Fptzd_1), param);
        ...
        public override BaseResult Add(dynamic entity)
        {
            ...
            var model = entity as FptzdModel;
            #region 参数验证
            ...
            if (DAL.GetCount(typeof(Td_Ps_Fptzd_1), _ck_parm) > 0)
            {
                res.Success = false;
            ...
            #endregion
            Td_Ps_Fptzd_1 fptzd1 = new Td_Ps_Fptzd_1()
            {
                #region 赋值
                ...
                bm_djlx = Enums.Ps.PS220.ToString(),
            ...
            model.id = fptzd1.id;
            //fptzd1.bz = fptzd1.bz.Trim();
            List<Td_Ps_Fptzd_2> fptzd2S = new List<Td_Ps_Fptzd_2>();
            if (!string.IsNullOrEmpty(model.json_data))
            {
                fptzd2S = JSON.Deserialize<List<Td_Ps_Fptzd_2>>(model.json_data);
                if (fptzd2S.Any())
                {
                    int sort = 1;
                    fptzd2S.ForEach(a =>
                    {
                        a.id = GetGuid;
                        a.id_masteruser = fptzd1.id_masteruser;
                        a.id_bill = fptzd1.id;
            ...
            var id_sps = (from p in fptzd2S select p.id_sp).ToArray();
            var id_shops = new string[] { model.id_shop_ck, model.id_shop_rk };
            ...
            if (model.AutoAudit)
            {
                ...
                Sh<Td_Ps_Fptzd_1>(res, param, "p_ps_fptzd_sh");
            }
            return res;
        }
        private bool CheckModel2(BaseResult res, Td_Ps_Fptzd_2 model)
        {
            if (model == null)
            {
                res.Success = false;
        ...
        public override BaseResult Update(dynamic entity)
        {
            ...
            DAL.UpdatePart(typeof(Td_Ps_Fptzd_1), param);
            param.Clear();
            param.Add("id_bill", model.id);
            param.Add("id_masteruser", model.id_masteruser);
            DAL.Delete(typeof(Td_Ps_Fptzd_2), param);
            DAL.AddRange(fptzd2S);
        ...
        {
            BaseResult res = new BaseResult() { Success = true };
            Sh<Td_Ps_Fptzd_1>(res, param, "p_ps_fptzd_zf");
            return res;
        }
        ...
        public override BaseResult Delete(Hashtable param)
        {
            ...
            param.Add("id", id);
            var model = DAL.GetItem<Td_Ps_Fptzd_1>(typeof(Td_Ps_Fptzd_1), param);
            if (model == null)
            {
                res.Success = false;
                res.Message.Add("参数有误!");
            ...
            if (DAL.UpdatePart(typeof(Td_Ps_Fptzd_1), param) <= 0)
            {
                res.Success = false;
