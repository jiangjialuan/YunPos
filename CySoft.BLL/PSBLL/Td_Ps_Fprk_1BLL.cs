...
namespace CySoft.BLL.PSBLL
{
    ...
    public class Td_Ps_Fprk_1BLL:BaseBLL
    {
        #region 获取分页数据
        public override PageNavigate GetPage(Hashtable param = null)
        {
            PageNavigate pn = new PageNavigate() { Success = true };
            var totalCount = DAL.GetCount(typeof(Td_Ps_Fprk_1), param);
            if (totalCount > 0)
            {
                pn.Data = DAL.QueryPage<Td_Ps_Fprk_1_Query>(typeof(Td_Ps_Fprk_1), param);
        ...
        private void GetIdShopSk(BaseResult res, PsfprkModel model)
        {
            ...
            _ck_parm.Add("id_shop_child", model.id_shop_ck);
            ...
            //_ck_parm.Add("id_masteruser", model.id_masteruser);
            //_ck_parm.Add("id", model.id_shop_ck);
            //var shop = DAL.GetItem<Tb_Shop>(typeof(Tb_Shop), _ck_parm);
            //if (shop == null)
            //{
            //    res.Success = false;
            //    res.Message.Add("退货门店不存在!");
            //    return;
            //}
            ...
            //    _ck_parm.Add("flag_state", 1);
            //    _ck_parm.Add("flag_delete", 0);
            //    _ck_parm.Add("id_shop_child", shop.id);
            //    var shopshop = DAL.GetItem<Tb_Shop_Shop>(typeof(Tb_Shop_Shop), _ck_parm);
            //    if (shopshop != null && !shopshop.id_shop_father.IsEmpty())
            //    {
            //        model.id_shop_sk = shopshop.id_shop_father;
        ...
        public override BaseResult Add(dynamic entity)
        {
            ...
            var model = entity as PsfprkModel;
            #region 参数验证
            ...
            _ck_parm.Add("id_masteruser", model.id_masteruser);
            if (DAL.GetCount(typeof(Td_Ps_Fprk_1), _ck_parm) > 0)
            {
                res.Success = false;
            ...
            #endregion
            Td_Ps_Fprk_1 model1 = new Td_Ps_Fprk_1()
            {
                #region 赋值
                ...
                bm_djlx = Enums.Ps.PS240.ToString(),
            ...
            List<Td_Ps_Fprk_2> model2S = new List<Td_Ps_Fprk_2>();
            if (!string.IsNullOrEmpty(model.json_data))
            {
                model2S = JSON.Deserialize<List<Td_Ps_Fprk_2>>(model.json_data);
                if (model2S.Any())
                {
                    int sort = 1;
                    model2S.ForEach(a =>
            ...
            var id_shops = new string[] { model1.id_shop, model1.id_shop_ck };
            ht.Add("id_shop_array", id_shops);
            ht.Add("id_sp_array", id_sps);
            ht.Add("id_masteruser", model1.id_masteruser);
            ...
            if (model.AutoAudit)
            {
                ...
                Sh<Td_Ps_Fprk_1>(res, param, "p_ps_fprk_sh");
            }
            return res;
        }
        private bool CheckModel2(BaseResult res, Td_Ps_Fprk_2 model)
        {
            if (model == null)
            {
                res.Success = false;
        ...
        public override BaseResult Update(dynamic entity)
        {
            ...
            DAL.UpdatePart(typeof(Td_Ps_Fprk_1), param);
            param.Clear();
            param.Add("id_bill", model.id);
            param.Add("id_masteruser", model.id_masteruser);
            DAL.Delete(typeof(Td_Ps_Fprk_2), param);
            DAL.AddRange(model2S);
            return res;
        }
        ...
        {
            BaseResult res = new BaseResult() { Success = true };
            Sh<Td_Ps_Fprk_1>(res, param, "p_ps_fprk_zf");
            return res;
        }
        ...
        {
            BaseResult res = new BaseResult() { Success = true };
            var model1 = DAL.GetItem<Td_Ps_Fprk_1>(typeof(Td_Ps_Fprk_1), param);
            PsfprkQueryModel model = new PsfprkQueryModel();
            if (model1 != null)
            {
                param.Clear();
                param.Add("id_bill", model1.id);
                param.Add("sort", "  sort_id  ");
                model.model2List = DAL.QueryList<Td_Ps_Fprk_2_Query>(typeof(Td_Ps_Fprk_2), param).ToList();
        ...
        public override BaseResult Delete(Hashtable param)
        {
            ...
            param.Add("id", id);
            var model = DAL.GetItem<Td_Ps_Fprk_1>(typeof(Td_Ps_Fprk_1), param);
            if (model == null)
            {
                res.Success = false;
                res.Message.Add("参数有误!");
            ...
            if (DAL.UpdatePart(typeof(Td_Ps_Fprk_1), param) <= 0)
            {
                res.Success = false;
