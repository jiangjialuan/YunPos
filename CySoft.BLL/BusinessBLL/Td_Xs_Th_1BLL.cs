...
namespace CySoft.BLL.BusinessBLL
{
    ...
    public class Td_Xs_Th_1BLL : BaseBLL
    {
        ...
        public override PageNavigate GetPage(Hashtable param = null)
        {
            ...
            var totalCount = DAL.GetCount(typeof(Td_Xs_Th_1), param);
            if (totalCount > 0)
            {
                pn.Data = DAL.QueryPage<Td_Xs_Th_1_QueryModel>(typeof(Td_Xs_Th_1), param);
        ...
        public override BaseResult Get(Hashtable param)
        {
            ...
            try
            {
                Td_Xs_Th_1_Query_DetailModel result = new Td_Xs_Th_1_Query_DetailModel();
                var head = DAL.GetItem<Td_Xs_Th_1_QueryModel>(typeof(Td_Xs_Th_1), param);
                if (head != null && !string.IsNullOrEmpty(head.id))
                {
                    ...
                    var body = DAL.QueryList<Td_Xs_Th_2_QueryModel>(typeof(Td_Xs_Th_2), param);
        ...
        public override BaseResult Add(dynamic entity)
        {
            ...
            var td_Jh_Th_2_List = (List<Td_Xs_Th_2>)param["shopspList"];
            var digit = param["DigitHashtable"] as System.Collections.Hashtable;//小数点控制 

            var td_Xs_Th_1_Model = this.TurnTd_Jh_1Model(param);
            int xh = 1;

            foreach (var item in td_Jh_Th_2_List)
            {
                item.id = Guid.NewGuid().ToString();
                item.id_masteruser = td_Xs_Th_1_Model.id_masteruser;
                item.id_bill = td_Xs_Th_1_Model.id;
                item.sort_id = xh;
                item.rq_create = td_Xs_Th_1_Model.rq_create;
                xh++;
            }
            td_Xs_Th_1_Model.je_mxtotal = td_Jh_Th_2_List.Sum(d => d.je);
            #endregion

            #region 检查单号是否重复

            ht.Clear();
            ht.Add("id_masteruser", td_Xs_Th_1_Model.id_masteruser);
            ht.Add("dh", td_Xs_Th_1_Model.dh);
            ...
            var shopModel = QueryShopById(td_Xs_Th_1_Model.id_shop);
            ...
            #region 插入数据库
            DAL.Add(td_Xs_Th_1_Model);
            DAL.AddRange<Td_Xs_Th_2>(td_Jh_Th_2_List);
            #endregion
        ...
        public BaseResult ActiveWork(Hashtable param)
        {
            ...
            {
                #region 校验商品合法性
                Td_Xs_Th_1_Query_DetailModel dbModel = (Td_Xs_Th_1_Query_DetailModel)brJh.Data;
        ...
        public override BaseResult Stop(Hashtable param)
        {
            ...
            try
            {
                if (DAL.UpdatePart(typeof(Td_Xs_Th_1), ht) <= 0)
                {
                    result.Success = false;
        ...
        public override BaseResult Update(dynamic entity)
        {
            ...
            ht.Add("new_je_st", param["je_st"].ToString());

            DAL.UpdatePart(typeof(Td_Xs_Th_1), ht);

            ht.Clear();
            ht.Add("id_bill", param["id"].ToString());
            DAL.Delete(typeof(Td_Xs_Th_2), ht);
            DAL.AddRange<Td_Xs_Th_2>(td_Jh_Th_2_List);
            #endregion
            br.Message.Add(String.Format("操作成功!"));
            br.Success = true;
        ...
        ///// 进货过账 更新货插入库存
        ///// </summary>
        ///// <param name="td_Xs_Th_1_Model"></param>
        ///// <param name="td_Jh_Th_2_List"></param>
        ///// <param name="digit"></param>
        //public void JH_ChangeKC(Td_Xs_Th_1 td_Xs_Th_1_Model, List<Td_Xs_Th_2> td_Jh_Th_2_List, Hashtable digit)
        //{
        //    Hashtable ht = new Hashtable();
        //    foreach (var item in td_Jh_Th_2_List)
        //    {
        ...
        //        var id_shop = td_Xs_Th_1_Model.id_shop;
        //        ht.Clear();
        //        ht.Add("id_masteruser", id_masteruser);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        private Td_Xs_Th_1 TurnTd_Jh_1Model(Hashtable param)
        {
            Td_Xs_Th_1 model = new Td_Xs_Th_1();
            ...
            model.je_mxtotal = 0m;
            model.je_st = decimal.Parse(param["je_st"].ToString());
